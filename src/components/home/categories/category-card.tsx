      ...
      <div className="group relative flex h-56 flex-col justify-end overflow-hidden p-6 transition-colors hover:bg-neutral-800 md:h-80 md:p-9">
        ...
        <div className="relative z-10 space-y-2">
          ...
          <div className="h-16 md:h-20 flex items-end">
            <h3 className="text-2xl md:text-3xl leading-tight transition-transform duration-500 group-hover:-translate-y-3 text-white line-clamp-2 overflow-hidden">
              {category.name}
            </h3>
          </div>
        ...
        {/* Background Image */}
        <div
          className="absolute bottom-0 left-0 right-0 top-0 opacity-0 blur-sm grayscale transition-all duration-500 group-hover:opacity-30 group-hover:blur-none group-hover:grayscale-0 group-active:scale-105 group-active:opacity-50"
          style={{
